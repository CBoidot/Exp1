...
en effet ce fut laborieux, notamment avec l'ajout des transitions.

copié le 28 mars 2022 pour tenter des déploiement sur le cloud de streamlit.


@author: Corentin.Boidot
"""

print("Oui, je suis là Corentin.")
...
print("J'ai survécu aux imports.")
